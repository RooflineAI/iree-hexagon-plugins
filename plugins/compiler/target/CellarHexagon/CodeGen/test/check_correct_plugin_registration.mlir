...
// This test is just making sure that the configuration pipeline and therefore the plugin as a whole are properly registered
// It is therefore not even testing the output of the pipeline

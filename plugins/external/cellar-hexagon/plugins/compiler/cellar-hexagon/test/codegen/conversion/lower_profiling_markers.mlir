...
// CHECK-DAG: llvm.func @hexagon_runtime_profiling_zone_begin(i32, !llvm.ptr) -> !llvm.ptr attributes {cellar_hexagon.native_runtime_link}
// CHECK-DAG: llvm.func @hexagon_runtime_profiling_zone_end(!llvm.ptr) attributes {cellar_hexagon.native_runtime_link}
// CHECK-LABEL: llvm.func @kernel()
// CHECK: %[[ZONE:.*]] = llvm.mlir.constant(7 : i32) : i32
// CHECK: %[[INFO:.*]] = llvm.getelementptr
// CHECK: %[[RECORD:.*]] = llvm.call @hexagon_runtime_profiling_zone_begin(%[[ZONE]], %[[INFO]]) : (i32, !llvm.ptr) -> !llvm.ptr
// CHECK: llvm.call @hexagon_runtime_profiling_zone_end(%[[RECORD]]) : (!llvm.ptr) -> ()
